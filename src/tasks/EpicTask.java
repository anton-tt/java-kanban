...
public class EpicTask extends Task {
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(name, otherEpicTask .name) &&
                Objects.equals(description, otherEpicTask .description) &&
                Objects.equals(status, otherEpicTask.status) &&
                Objects.equals(getEpictaskSubtasks(), otherEpicTask.getEpictaskSubtasks()) &&
                (getId() == otherEpicTask.getId());
    }
    @Override
    public int hashCode() {
